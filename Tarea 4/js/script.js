document.addEventListener("DOMContentLoaded", function () {
    ...
    contactForm.addEventListener("submit", (e) => {
        ...
        // Puedes hacer lo que quieras con los datos, como mostrarlos en la página
        ...
        // También puedes realizar otras acciones con los datos aquí
    });
    ...
    calculateAgeButton.addEventListener("click", () => {
        ...
        const ownerAge = 22; // Reemplaza con tu edad
        const difference = userAge - ownerAge;
        ageDifference.textContent = `La diferencia de edad es ${difference} años.`;
    });
